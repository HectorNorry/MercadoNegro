        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Movimientos_Usuarios_DestinatarioId",
                        column: x => x.DestinatarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Movimientos_Usuarios_RemitenteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Movimientos_DestinatarioId",
                table: "Movimientos",
                column: "DestinatarioId");

            migrationBuilder.CreateIndex(
                name: "IX_Movimientos_RemitenteId",
                table: "Movimientos",
                column: "RemitenteId");

            migrationBuilder.CreateIndex(
                name: "IX_Usuarios_Cvu",
                table: "Usuarios",
                column: "Cvu",
                unique: true);
        }
